...
<%
	...
	MemberDTO dto = dao.getReadData(num);
	...
	if(dto==null) {
		response.sendRedirect("member_list.jsp" + pageNum + param);
	}
...
<div id="bbs">
	...
	<div id="bbsCreated">
		...
		<div class="bbsCreated_bottomLine">
			<dl>
				<dt>이&nbsp;&nbsp;&nbsp;&nbsp;름</dt>
				<dd>
				<input type="text" name="name" value="<%=dto.getName() %>" size="20" 
		...
		<div class="bbsCreated_bottomLine">
			<dl>
				<dt>아이디</dt>
				<dd>
					<input type="text" name="id" value="<%=dto.getId() %>" size="20" maxlength="20" class="boxTF" />
		...
		<div class="bbsCreated_bottomLine">
			<dl>
				<dt>비밀번호</dt>
				<dd>
					<input type="password" name="pwd" value="<%=dto.getPwd() %>" size="20" maxlength="20" class="boxTF" />
				</dd>
			</dl>		
		</div>
		...
		<div class="bbsCreated_bottomLine">
			<dl>
				<dt>비밀번호 확인</dt>
				<dd>
					<input type="password" name="pwdConfirm"  value="<%=dto.getPwdConfirm() %>"size="20" maxlength="20" class="boxTF" />
				</dd>
			</dl>		
		</div>
		...
		<div class="bbsCreated_bottomLine">
			<dl>
				<dt>이메일</dt>
				<dd>
					<input type="text" name="email1" value="<%=dto.getEmail1() %>" size="20" maxlength="50" class="boxTF" />
					@
					<select name="email2">
		...
		<div class="bbsCreated_bottomLine">
			<dl>
				...
				<dd>
					...
					-
					<input type="text" name="phoneNumber2" value="<%=dto.getPhoneNumber2() %>" size="5" maxlength="4" class="boxTF" /> 
					-
					<input type="text" name="phoneNumber3" value="<%=dto.getPhoneNumber3() %>" size="5" maxlength="4" class="boxTF" />
				</dd>
			</dl>		
		</div>
		...
		<div class="bbsCreated_bottomLine">
			<dl>
				<dt>주소</dt>
				<dd>
					<input type="text" name="address" value="<%=dto.getAddress() %>"  size="60" maxlength="100" class="boxTF" />
				</dd>
			</dl>		
		</div>
		...
		<!-- 생년월일 -->
      	<div class="bbsCreated_bottomLine">
  			<dl>
    			<dt>생년월일</dt>
    			<dd>
      				<input type="text" name="birthYear" value="<%=dto.getBirthYear() %>" size="5" maxlength="4" id="birthYear" placeholder="YYYY" class="boxTF" />년
      				<input type="text" name="birthMonth" value="<%=dto.getBirthMonth() %>" size="3" maxlength="2" id="birthMonth" placeholder="MM" class="boxTF" />월
      				<input type="text" name="birthDay" value="<%=dto.getBirthDay() %>" size="3" maxlength="2" id="birthDay" placeholder="DD" class="boxTF" />일
    			</dd>
  			</dl>
		</div>
		...
		<div id="bbsCreated_content">
  			<dl>
    			<dt>자기소개</dt>
    			<dd>
      				<textarea rows="12" cols="63" name="intro" class="boxTA"><%=dto.getIntro() %></textarea>
    			</dd>
  			</dl>
		</div>
		...
		<div class="bbsCreated_bottomLine">
  			<dl>
    			...
    			<dd>
      				...
      				<input type="text" name="image" value="<%=dto.getImagePath() %>" size="30" class="boxTF" id="imageInput" readonly />
	...
	<div id="bbsCreated_footer">
		...
		onclick="javascript:location.href='member_list.jsp?pageNum=<%=pageNum%><%=param%>';"/>
